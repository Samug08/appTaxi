...
DECLARE
    u_url VARCHAR2(100) := 'http://131.114.73.203:8080/apex/utenter2324';
BEGIN
    --gruppo1
    ...
    INSERT INTO Permissions VALUES ('Visualizza Corse Prenotate',u_url || '.gruppo1.visCorsePren?p_idSess=', 'Cliente;Autista;Manager', 1);
    ...
    INSERT INTO Permissions VALUES ('Statistiche su luoghi popolari',u_url || '.gruppo1.luoghiPopolari?p_idSess=', 'Manager', 1);


    --gruppo2
    INSERT INTO Permissions VALUES ('Visualizza Taxi',u_url || '.gruppo2.visualizzaTaxi?id_ses=', 'Autista;Operatore;Manager;Cliente', 2);
    INSERT INTO Permissions VALUES ('Visualizza Corse Non Prenotate',u_url || '.gruppo2.visualizzaCorseNonPrenotate?id_ses=', 'Autista;Manager;Contabile', 2);
    ...
    INSERT INTO Permissions VALUES ('Inserisci Buste Paga',u_url || '.Gruppo3.inserimentoBustaPaga?idSess=', 'Contabile', 3);
    INSERT INTO Permissions VALUES ('Visualizza Ricariche Cliente',u_url || '.Gruppo3.visualizzaRicaricheCliente?idSess=', 'Cliente', 3);
    INSERT INTO Permissions VALUES ('Dettagli Stipendi Personale',u_url || '.Gruppo3.dettagliStipendiPersonale?idSess=', 'Manager', 3);
    INSERT INTO Permissions VALUES ('Dettagli Ricariche Cliente',u_url || '.Gruppo3.dettagliRicaricheClienti?idSess=', 'Manager', 3);
    INSERT INTO Permissions VALUES ('Inserisci Convenzione',u_url || '.Gruppo3.inserisciConvenzione?idSess=', 'Manager', 3);
    ...
    INSERT INTO Permissions VALUES ('Visualizzazione Dipendenti',u_url || '.Gruppo4.visualizzazioneDipendenti?idSessione=', 'Autista;Operatore;Manager;Contabile', 4);
    ...
    INSERT INTO Permissions VALUES ('Inserisci patente',u_url || '.Gruppo4.inserimentoPatente?idSessione=', 'Manager', 4);
